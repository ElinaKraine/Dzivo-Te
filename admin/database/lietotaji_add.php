...
if (!empty($vards) && !empty($uzvards) && !empty($epasts) && !empty($talrunis) && !empty($parole) && !empty($paroleAtkartoti) && !empty($loma) && !empty($attels)) {
    ...
    } elseif ($_FILES['attelsTabulaAdmin']['error'] === UPLOAD_ERR_OK) {
