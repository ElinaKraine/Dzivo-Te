                    ...
                    <tr>
                        ...
                        <td>
                            <form method='POST' action='edit_lietotaju.php'>
                                <button type='submit' name='apskatitIeraksts' class='Tbtn' value='{$ieraksts['iret_id']}'><i class='fas fa-edit'></i></button>
                            </form>
                        </td>
                        <td>
                            <form method='POST' onsubmit='return confirm(\"Vai tiešām vēlēs dzēst?\");'>
                                <input type='hidden' name='delete_id' value='{$ieraksts['iret_id']}'>
                                <button type='submit' name='nodzestIeraksts' class='Tbtn' value='{$ieraksts['iret_id']}'><i class='fas fa-trash'></i></button>
                            </form>
                        </td>
                    </tr>
                ";
