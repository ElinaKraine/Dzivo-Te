...
function initializeFilterToggle() {
    document.querySelectorAll('.filter-poga').forEach(button => {
        button.addEventListener('click', function() {
            ...
            document.querySelectorAll('.cenuDiapozons, .istabasDiapozons, .platibasDiapozons, .staviDiapozons').forEach(div => {
                if (div !== dropdown) {
...
function parslegtPogasKlases(clickedButton) {
    ...
    neAtlasitaPoga.classList.toggle('neAtlasits', clickedButton !== neAtlasitaPoga);
}
