...
if (isset($_POST['id']) && isset($_POST['veids'])) {
    ...
    $json = [
        ...
        "cena" => isset($dati['cena']) ? htmlspecialchars($dati['cena']) : null,
        "cena_diena" => isset($dati['cena_diena']) ? htmlspecialchars($dati['cena_diena']) : null,
        "cena_nedela" => isset($dati['cena_nedela']) ? htmlspecialchars($dati['cena_nedela']) : null,
        "cena_menesis" => isset($dati['cena_menesis']) ? htmlspecialchars($dati['cena_menesis']) : null,
